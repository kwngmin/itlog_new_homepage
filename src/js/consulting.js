...
const arrow = document.getElementById('agreeArrow');
arrow.addEventListener('click', function () {
    document.querySelector('.consulting-agree').classList.toggle("arrow-clicked");
...
send.addEventListener('click', function () {
    ...
    let productCheck = document.querySelectorAll('input[name="product-check"]:checked').length;
